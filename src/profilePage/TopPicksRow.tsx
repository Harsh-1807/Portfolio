...
import { FaPassport, FaCode, FaBriefcase, FaCertificate, FaHandsHelping, FaProjectDiagram, FaEnvelope, FaMusic, FaBook, FaGamepad } from 'react-icons/fa';
...
const topPicksConfig = {
  ...
  developer: [
    ...
    { title: "Video Games", imgSrc: "https://picsum.photos/seed/gaming/250/200", route: "/video-games", icon: <FaGamepad /> },
